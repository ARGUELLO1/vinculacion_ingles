<div>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-white leading-tight">
                Gestión de Constancias - {{ $nivelInfo['nivel_grupo'] ?? '' }}
            </h2>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="bg-orange-50 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-orange-800">Total Constancias</h3>
                            <p class="text-lg font-semibold text-orange-900">{{ $conteoConstanciasNivel }}</p>
                        </div>
                    </div>
                ...
                <div class="p-6 border-b border-gray-200 bg-gray-50">
                    <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Gestiona todas las constancias del grupo</p>
                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <span
                                            ...
                                            {{ $alumno->constancias_count > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                            {{ $alumno->constancias_count }} constancia(s)
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        @if ($alumno->constancias_count > 0)
                                            <button wire:click="verConstanciasAlumno({{ $alumno->id_alumno }})"
                    ...
                    <div class="border-t border-gray-200 p-6 bg-gray-50">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium text-gray-900">
                                Constancias de {{ $alumnoDetalle->nombre_completo }}
                            </h3>
                        ...
                        @if ($constanciasAlumno && $constanciasAlumno->count() > 0)
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($constanciasAlumno as $constancia)
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span class="text-sm font-medium text-gray-900">
                                                            Constancia_{{ $loop->iteration }}.pdf
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    {{ \Carbon\Carbon::parse($constancia->created_at)->format('d/m/Y H:i') }}
                                                </td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                                    <div class="flex justify-center space-x-2">
                                                        <!-- Ver Constancia -->
                                                        <a href="{{ route('documentos.alumno.ver', $constancia->id_documento) }}"
                                                            target="_blank"
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-2 text-lg font-medium text-gray-900">No hay constancias para este alumno
                                </p>
                                <p class="text-gray-500">Utiliza el botón "Subir" para agregar constancias.</p>
                            </div>
                        @endif
                    </div>
                @endif
    ...
    <livewire:modal-global.documentos.constancias-modal />
    <livewire:modal-global.documentos.constancias-alumno-modal />
    <livewire:modal-global.documentos.eliminar-constancias-alumno-modal />
</div>
