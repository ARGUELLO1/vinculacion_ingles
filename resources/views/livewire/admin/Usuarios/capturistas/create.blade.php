                ...
                <section>
                    <form wire:submit='save' class="mt-6 space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ request()->routeIs('admin.capturistas.create') ? 'Crear' : 'Actualizar' }}</x-primary-button>
                            <x-danger-button :href="route('admin.capturistas.index')" wire:navigate>{{ __('Cancelar') }}</x-danger-button>
                        </div>
                    </form>
                </section>
            </div>
