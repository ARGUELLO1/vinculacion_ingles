<div>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <x-primary-button :href="route('admin.coordinadores.create')" wire:navigate>
                + Crear Coordinador
            </x-primary-button>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                        <div class="flex-1">
                            <x-text-input wire:model.live="search" placeholder="Buscar coordinadores..."
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($coordinadores as $user)
                                <tr>
                                    <td class="text-center px-6 py-4 whitespace-nowrap">
                                        {{ $user->coordinador?->id_coordinador ?? 'N/A' }}
                                    </td>
                                    <td class="text-center px-6 py-4 whitespace-nowrap">
                                        {{ $user->coordinador?->nombre_completo ?? $user->name }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            ...
                                            <x-secondary-button :href="route('admin.coordinadores.edit', $user->coordinador)" wire:navigate>
                                                Editar
                                            </x-secondary-button>

                                            <x-danger-button
                                                wire:click="$dispatch('openDeleteUserModal', { userId: {{ $user->id }}, userType: 'coordinador' })">
                                                Eliminar
                                            </x-danger-button>
                                        </div>
                                    </td>
    ...
    @if (session('success'))
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
            ...
            class="pointer-events-auto fixed inset-0 z-40 flex items-center justify-center p-4">
