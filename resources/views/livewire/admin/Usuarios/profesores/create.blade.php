                    ...
                    <form wire:submit='save' class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-select wire:model="form.estatus" name="estatus" id="estatus" class="mt-1 block w-full"
                                ...
                                @if (request()->routeIs('admin.profesores.create'))
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ request()->routeIs('admin.profesores.create') ? 'Crear' : 'Actualizar' }}</x-primary-button>
                            <x-danger-button :href="route('admin.profesores.index')" wire:navigate>{{ __('Cancelar') }}</x-danger-button>
                        </div>
                    </form>
                </section>
            </div>
