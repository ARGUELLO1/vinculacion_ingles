<div>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <x-primary-button :href="route('admin.profesores.create')" wire:navigate>
                + Crear Profesor
            </x-primary-button>
        </div>
    </x-slot>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            ...
                                            <x-secondary-button :href="route('admin.profesores.edit', $user->profesor)" wire:navigate>
                                                Editar
                                            </x-secondary-button>

                                            <x-danger-button
                                                wire:click="$dispatch('openDeleteUserModal', { userId: {{ $user->id }}, userType: 'profesor' })">
                                                Eliminar
                                            </x-danger-button>
                                        </div>
                                    </td>
