                    ...
                    <form wire:submit='save' class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-select wire:model="form.profesor" id="profesor" name="profesor"
                                ...
                                @if (request()->routeIs('capturista.niveles.create'))
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ request()->routeIs('capturista.niveles.create') ? 'Crear' : 'Actualizar' }}</x-primary-button>
                            <x-danger-button :href="route('capturista.niveles.index')" wire:navigate>{{ __('Cancelar') }}</x-danger-button>
                        </div>
                    </form>
                </section>
            </div>
