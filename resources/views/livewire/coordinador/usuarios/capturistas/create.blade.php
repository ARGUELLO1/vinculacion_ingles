            ...
            <div class="max-w-xl">
                ...
                <section>
                    <form wire:submit='save' class="mt-6 space-y-6">
                        ...
                        @if (!isset($this->form->capturistaEdit))
                            <div>
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ request()->routeIs('coordinador.capturistas.create') ? 'Crear' : 'Actualizar' }}</x-primary-button>
                            <x-danger-button :href="route('coordinador.capturistas.index')" wire:navigate>{{ __('Cancelar') }}</x-danger-button>
                        </div>
                    </form>
                </section>
            </div>
