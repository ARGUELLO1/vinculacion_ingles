                ...
                <section>
                    <form wire:submit='save' class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-select wire:model="form.estatus" name="estatus" id="estatus" class="mt-1 block w-full"
                                required autofocus autocomplete="estatus">
                                @if (request()->routeIs('coordinador.profesores.create'))
                        ...
                        <div>
                            ...
                            <x-select wire:model="form.sexo" id="sexo" name="sexo" class="mt-1 block w-full"
                                required autofocus autocomplete="sexo">
                                @if (request()->routeIs('coordinador.profesores.create'))
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('form.sexo')" />
                        </div>
                        ...
                        @if (!isset($this->form->profesorEdit))
                            <div>
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ request()->routeIs('coordinador.profesores.create') ? 'Crear' : 'Actualizar' }}</x-primary-button>
                            <x-danger-button :href="route('coordinador.profesores.index')" wire:navigate>{{ __('Cancelar') }}</x-danger-button>
                        </div>
                    </form>
                </section>
            </div>
